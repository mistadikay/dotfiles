...
Then explore the codebase using the current harness's best available mechanism: Claude Code's Agent tool with `subagent_type=Explore`, OpenCode's Explore agent, Codex sub-agents/explorers, or direct local search/read tools. Don't follow rigid heuristics — explore organically and note where you experience friction:
